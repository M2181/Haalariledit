...
#include <math.h>
int vihtu;
int val; #muuttujat ledeille
int val1;
int val2;
int val3;
Adafruit_NeoPixel strip(LED_COUNT, LED_PIN, NEO_GRB + NEO_KHZ800); #otetaan adafruit käyttöön
...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        fifoCount -= packetSize;
            ...
            strip.setPixelColor(val2, 0, 0, 0);
            strip.setPixelColor(val1, 0, 0, 0);
            strip.setPixelColor(val3, 0, 0, 0);
            strip.show();
            // display Euler angles in degrees
            mpu.dmpGetQuaternion(&q, fifoBuffer);
